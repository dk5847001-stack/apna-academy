    ...
    <main className="app-shell min-h-screen w-full bg-white text-slate-900">
        ...
        <div className="hero-grid">
          <div className="hero-copy">
            ...
            <div className="hero-buttons">
              <button className="gradient-btn" onClick={() => navigate(ROUTES.INTERVIEW_SETUP)}>Start Practicing Free <ArrowForward /></button>
              <button className="outline-btn" onClick={() => navigate(ROUTES.DEMO)}><span className="play-circle"><PlayArrowRounded /></span> Watch Demo</button>
            </div>
      ...
      <section id="pricing" className="cta-section page-section">
        <div className="cta-inner" id="start">
          ...
          <button className="white-btn" onClick={() => navigate(ROUTES.LOGIN)}>Get Started Free <ArrowForward /></button>
        </div>
      </section>
