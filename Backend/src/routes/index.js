...
import adminAIUsageRoutes from "./admin.aiUsage.routes.js";
...
router.use("/ai/learning", aiLearningRoutes);
router.use("/ai", aiUsageRoutes);
...
router.use("/admin/ai", adminAIUsageRoutes);
