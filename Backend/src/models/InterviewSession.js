...
const interviewSessionSchema = new mongoose.Schema({
  ...
  analytics: {
    ...
    plannedQuestionCount: { type: Number, min: 0, default: 0 },
    followUpCount: { type: Number, min: 0, default: 0 },
    completionRate: { type: Number, min: 0, max: 100, default: 0 },
    averageAnswerScore: { type: Number, min: 0, max: 100, default: 0 },
    consistencyScore: { type: Number, min: 0, max: 100, default: 0 },
    scoreRange: { type: Number, min: 0, max: 100, default: 0 },
    averageAnswerLength: { type: Number, min: 0, default: 0 },
    categoryScores: { type: [mongoose.Schema.Types.Mixed], default: [] },
    strongestCategory: { type: String, maxlength: 100, default: "" },
    focusCategory: { type: String, maxlength: 100, default: "" },
