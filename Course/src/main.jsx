        ...
        <div className="flex items-start gap-3.5 p-4 pl-5">
          ...
          <div className="min-w-0 flex-1 pr-6">
            <div className="flex items-center gap-2">
              <span className="text-[0.72rem] font-bold uppercase tracking-[0.16em] text-emerald-400">Available now</span>
              <span className="h-1.5 w-1.5 rounded-full bg-emerald-400 shadow-[0_0_10px_rgba(52,211,153,0.8)]" />
            </div>
            <h3 className="mt-1 text-[0.98rem] font-extrabold leading-tight text-white">Demo Class is ready</h3>
            <p className="mt-1.5 text-[0.78rem] leading-5 text-slate-400">Explore the free demo before you enroll.</p>
            <button type="button" onClick={openDemoClass} className="mt-3 inline-flex items-center gap-1.5 rounded-lg bg-emerald-500 px-3.5 py-2 text-xs font-extrabold text-slate-950 shadow-[0_8px_22px_rgba(16,185,129,0.22)] transition hover:bg-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-400/60">
              Watch Demo Class <span aria-hidden="true" className="text-sm leading-none">→</span>
            </button>
          </div>
          <button type="button" aria-label="Close Demo Class notification" onClick={closeNotification} className="absolute right-2.5 top-2.5 flex h-7 w-7 items-center justify-center rounded-full text-lg leading-none text-slate-500 transition hover:bg-white/10 hover:text-white focus:outline-none focus:ring-2 focus:ring-emerald-400/50">×</button>
        </div>
