...
const CompletedVideoIcon = () => (
  <svg
    ...
    stroke="currentColor"
    className="size-6"
    style={{ width: 18, height: 18, color: "#69d58a" }}
    aria-hidden="true"
  >
    <path
      strokeLinecap="round"
