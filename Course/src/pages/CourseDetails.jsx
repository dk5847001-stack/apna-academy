        ...
        >
          <Box>
            ...
            <Typography
              ...
              sx={{
                mt: 3,
                fontSize: { xs: "2rem", sm: "2.8rem", lg: "3.8rem" },
                lineHeight: 1.08,
                fontWeight: 900,
          ...
          >
            ...
            <CardContent sx={{ p: { xs: 2.5, sm: 3 } }}>
              ...
              <Button
                ...
                variant="contained"
                size="large"
                startIcon={paymentLoading ? <CircularProgress size={18} color="inherit" /> : <ShoppingCart />}
                disabled={paymentLoading}
                onClick={() => startPurchase("course")}
                sx={{ mt: 2.5, py: 1.35, borderRadius: 2.5, fontWeight: 900, textTransform: "none" }}
              >
              ...
              <Button
                ...
                sx={{ py: 1.2, borderRadius: 2.5, fontWeight: 900, textTransform: "none" }}
              >
            ...
            {modules.length === 0 ? (
              ...
              modules.map((module, moduleIndex) => {
                ...
                return (
                  <Accordion
                    key={moduleId}
                    expanded={expandedModule === moduleId}
                    onChange={() => setExpandedModule((current) => current === moduleId ? null : moduleId)}
                    disableGutters
                    elevation={0}
                    sx={{ border: "1px solid", borderColor: "divider", borderRadius: "16px !important", overflow: "hidden", "&:before": { display: "none" } }}
                  >
                        ...
                        {videos.map((video, videoIndex) => {
                          ...
                          return (
                            <Paper key={videoId || videoIndex} elevation={0} sx={{ p: 1.5, border: "1px solid", borderColor: "divider", borderRadius: 2.5, display: "flex", alignItems: "center", gap: 1.5 }}>
                              ...
                              <Box sx={{ minWidth: 0, flex: 1 }}>
                                <Typography fontWeight={750} sx={{ overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                              ...
                              {isPreview ? (
                                <Button
                                  size="small"
                                  variant="outlined"
                                  onClick={() => navigate(COURSE_ROUTES.VIDEO(slug, videoId))}
                                  sx={{ flexShrink: 0, borderRadius: 2, fontWeight: 800, textTransform: "none" }}
                                >
                                  Preview
                                </Button>
                              ) : (
        ...
        <Box sx={{ mt: { xs: 7, lg: 10 }, display: "grid", gridTemplateColumns: { xs: "1fr", md: "repeat(3,1fr)" }, gap: 2 }}>
          {[
            ...
            <Paper key={item.title} elevation={0} sx={{ p: 3, border: "1px solid", borderColor: "divider", borderRadius: 3 }}>
              <Box sx={{ width: 44, height: 44, borderRadius: 2, backgroundColor: "primary.50", color: "primary.main", display: "flex", alignItems: "center", justifyContent: "center" }}>
                {item.icon}
              </Box>
          ...
          <Stack direction={{ xs: "column", sm: "row" }} spacing={2} alignItems={{ xs: "flex-start", sm: "center" }} justifyContent="space-between">
            <Box>
              ...
              <Typography variant="body2" color="text.secondary" sx={{ mt: 0.5 }}>
                Continue your learning from your student dashboard.
              </Typography>
            </Box>
            <Button component="a" href={DASHBOARD_URL} variant="contained" sx={{ borderRadius: 2, fontWeight: 800, textTransform: "none" }}>
              Open Dashboard
            </Button>
          </Stack>
        </Paper>
