      ...
      <div className="shrink-0 border-t border-slate-100 p-3">
        <div className="grid grid-cols-2 gap-2">
          <button
            type="button"
            onClick={handleHome}
            className="flex min-h-10 items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-3 text-xs font-bold text-slate-600 transition-colors hover:bg-slate-50 hover:text-slate-900"
          >
        ...
        <button
          type="button"
          onClick={onLogout}
          className="mt-2 flex min-h-10 w-full items-center justify-center gap-2 rounded-xl px-3 text-xs font-bold text-slate-500 transition-colors hover:bg-red-50 hover:text-red-600"
        >
...
export default function DashboardLayout() {
  ...
  return (
    ...
    >
      {/* Desktop Sidebar */}
      <aside
        className="fixed inset-y-0 left-0 z-40 hidden border-r border-slate-200 bg-white lg:block"
        style={{
          width: SIDEBAR_WIDTH,
        }}
      >
        ...
        <header className="sticky top-0 z-30 border-b border-slate-200 bg-white/95 backdrop-blur">
          <div className="flex min-h-16 items-center justify-between gap-3 px-4 sm:px-6 lg:px-8">
            ...
            <div className="ml-auto flex items-center gap-1 sm:gap-2">
              ...
              <NavLink
                to={ROUTES.PROFILE}
                className="flex items-center gap-2 rounded-xl px-1.5 py-1 transition-colors hover:bg-slate-50 sm:px-2"
              >
                <Avatar
                  src={user?.avatar || ""}
                  alt={user?.name || "Student"}
